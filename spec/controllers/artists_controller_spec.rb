...
RSpec.describe ArtistsController, type: :controller do
  ...
  describe "POST #create" do 
    ...
    context "with invalid params" do 
      it "assigns a newly created but unnamed artist to @artist" do
  ...
  describe "PUT #update" do
    context "with valid params" do 
      ...
      it "assigns the requested artist as @artist" do
        artist = create(:artist)
        put :update, {:id => artist.to_param, :artist => attributes_for(:artist, :name => "Bob")}
      ...
      it "redirects to the artist" do
        artist = create(:artist)
        put :update, {:id => artist.to_param, :artist => attributes_for(:artist, :name => "Gob")}
  ...
  describe "DELETE #destroy" do 
    ...
    it "redirects to artist list" do
      artist = create(:artist)
      delete :destroy, {:id => artist.to_param}
